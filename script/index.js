...
// }
    ...
    <div class="text-2xl font-medium font-bangla">${word.meaning} / 
...
(${lesson.level_no})"  class="btn btn-outline btn-primary"><i class="fa-solid fa-book-open"></i>Lesson - ${lesson.level_no}
</button>`
